...
DOC_PKGS += uk.ac.lancs.mime.body
DOC_PKGS += uk.ac.lancs.http
DOC_PKGS += uk.ac.lancs.http.cache
DOC_PKGS += uk.ac.lancs.http.encoding
DOC_PKGS += uk.ac.lancs.http.field
DOC_PKGS += uk.ac.lancs.cgi
DOC_PKGS += uk.ac.lancs.cgi.path
